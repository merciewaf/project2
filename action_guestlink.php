...
require_once("db.php");
if(count($_POST)>0) {
	$sql = "UPDATE guestlink set action_taken='" . $_POST["action_taken"] . "', staff_id='" . $_POST["staff_id"] . "', status='Awaiting Feedback', action_time=NOW() WHERE gl_id='" . $_GET["gl_id"] . "'";
...
<div align="right" style="padding-bottom:5px;"><a href="index.php" class="link"><img alt='List' title='List' src='images/list.png' width='15px' height='15px'/> Back</a></div>
...
<td><input type="text" name="action_taken" class="txtField" value="<?php echo $row['action_taken']; ?>"></td>
</tr>
<td><label>Action By</label></td>
<td><select name="staff_id" class="form-control">
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
    	...
    	echo "<option value='".$row['staff_id']."'>".$row['fullname']."</option>";
...
<tr>
<td><input type="hidden" name="action_time"  /></td></tr>
<tr>
