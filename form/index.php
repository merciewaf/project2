	...
	<div class="container">
      <div class="">
		...
		<div class="well clearfix">
			<div class="pull-right"><button type="button" class="btn btn-xs btn-primary" id="command-add" data-row-id="0" style="color:;border-left: 30px">
			<span class="glyphicon glyphicon-print" ></span> PRINTGRID</button></div>
...
<table id="employee_grid" class="table table-condensed table-hover table-striped" width="60%" cellspacing="0" data-toggle="bootgrid">
			<thead>
				<tr>
					...
					<th data-column-id="DEPARMENT_NAME">DEPT</th>
            ...
            <div class="modal-body">
				...
				<input type="hidden" value="add" name="action" id="action">
                  <div class="form-group">
                    <label for="name" class="control-label">DEPT:</label>
                    <input type="text" class="form-control" id="name" name="name"/>
                  </div>
                  <div class="form-group">
                    <label for="salary" class="control-label">NOTES:</label>
